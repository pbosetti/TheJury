return {
    metadataFieldsForPhotos = {
        ...
        { id = 'ppaCritiqueSemanticSummary', title = 'PPA Critique Semantic Summary', dataType = 'string', searchable = false },
        ...
        { id = 'ppaCritiqueSemanticRationale', title = 'PPA Critique Semantic Rationale', dataType = 'string', searchable = false },
        { id = 'ppaCritiqueSemanticStrengths', title = 'PPA Critique Semantic Strengths', dataType = 'string', searchable = false },
        { id = 'ppaCritiqueSemanticImprovements', title = 'PPA Critique Semantic Improvements', dataType = 'string', searchable = false },
